    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap   transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                outline:
                    "text-[20px] font-normal border-2 border-black bg-transparent text-black hover:bg-black hover:text-light-yellow",
                secondary:
                    "rounded-full text-[20px] font-normal bg-azure text-black transition duration-100",
